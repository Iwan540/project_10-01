<template>
    <div>
        ...
        <el-table :data="tableData" style="margin-top: 20px;">
            ...
            <el-table-column prop="sname" label="Name" width="150" sortable>
            </el-table-column>
            <el-table-column prop="term" label="Term" width="150" sortable>
            </el-table-column>
            <el-table-column prop="details" label="Application Detail" sortable>
            ...
            <el-table-column prop="rate" label="Rates" width="150" sortable  >
                <template slot-scope="scope">
                    <el-tag :style="{ backgroundColor: '#409eff', color: 'white' }" v-if="!scope.row.rate || scope.row.rate === 'Unrated'">Unrated</el-tag>
            ...
            <el-table-column prop="priority" label="Priority" sortable >
                <template slot-scope="scope">
                    <div class="block">
                        <el-slider v-model="scope.row.priority" :step="5" @change="sliderChange(scope.row)">
                        </el-slider>
                    </div>
                </template>
            </el-table-column>
            <el-table-column prop="status" label="Status Setting"  v-if="user.priority==1">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.status" placeholder="select status" @change="sliderChange(scope.row)">
                        <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                </template>
            </el-table-column>
            <el-table-column prop="rate" label="Set Rates"  v-if="user.priority==3">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.rate" placeholder="select rate" @change="sliderChange(scope.row)">
                        <el-option v-for="item in rates" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                </template>
            </el-table-column>
      ...
      <PaginationTest
        ...
        <el-dialog title="Application" :visible.sync="ApplyFormVisible">
            <el-form ref="form" :model="application">
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="Academic Record" style="width: 60%"><br>
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="Full name" style="width: 100%;">
                            <el-input v-model="application.sname" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="UPI" style="width: 100%;">
                            <el-input v-model="application.upi" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="AUID" style="width: 100%;">
                            <el-input v-model="application.auid" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="Preferred email" style="width: 100%;">
                            <el-input v-model="application.email" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="12">
                      <el-form-item label="Enrolment details for the semester" style="width: 100%;">
                        <el-input v-model="application.enrolmentDetailsSemester" placeholder="degree / year - e.g. 2ⁿᵈ year BSc, 1ˢᵗ year PhD" disabled></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="Maximum working hours per week" style="width: 100%;">
                            <el-input v-model="application.workingHours" placeholder="Please enter an integer number" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
